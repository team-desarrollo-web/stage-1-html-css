...
2. All the commits have the corresponding format: `DW-XX: Capitalized description`.
...
# [DW-XXX: title-of-ticket](url_del_tablero/ticket)

> Ticket code, title of the ticket and as a hyperlink, the corresponding TRELLO link
